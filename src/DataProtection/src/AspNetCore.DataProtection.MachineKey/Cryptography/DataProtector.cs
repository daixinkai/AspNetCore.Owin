    ...
    abstract class DataProtector
    {
                                ...
                                string[] specificPurposes)
        {
            ...
            if (String.IsNullOrWhiteSpace(primaryPurpose))
                throw new ArgumentNullException(nameof(primaryPurpose));
            ...
            if (specificPurposes != null)
            {
                foreach (string purpose in specificPurposes)
                {
                    ...
                    {
                        throw new ArgumentException(nameof(specificPurposes));
                    }
                }
            }
        ...
        public byte[] Unprotect(byte[] encryptedData)
        {
            ...
            if (PrependHashedPurposeToPlaintext)
            {
                ...
                // Don't touch this code block without crypto board review
                {
                    ...
                    if (!hashedPurposeOK)
                    {
                        throw new CryptographicException("Cryptography_DataProtector_InvalidPurpose");
                    }
                }
